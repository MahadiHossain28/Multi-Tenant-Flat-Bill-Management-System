    ...
    <div class="w-100 flex-grow-1 d-flex justify-content-center align-items-center">
        <div class="w-25 border p-4 mx-3 form-container shadow-lg bg-body-tertiary rounded">
            ...
            <form action="{{ route('auth.login') }}" method="post">
                ...
                <x-form.input label="Email" id="email" type="email" placeholder="Enter Email Address"/>
                <x-form.input label="Password" id="password" type="password" placeholder="Enter Password"/>
